...
class CommandLog(models.Model):
    ...
    def __str__(self):
        return f"{self.command_name} ran at {self.executed_at}"
...
class CEMSRGeoServerLayerGroup(models.Model):
    """
    Tracks one GeoServer layer group for one CEMS product.
    """

    product = models.OneToOneField(
        "proximity_alerts.CEMSRProduct",
        on_delete=models.CASCADE,
    ...
    def __str__(self):
        return f"{self.workspace}:{self.group_name}"    